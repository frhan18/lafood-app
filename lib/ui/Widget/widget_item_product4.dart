import 'package:apk_lafood/ui/Home/detail_product4.dart';
import 'package:flutter/material.dart';
import 'package:apk_lafood/models/data.dart';

Widget buildWithItemProduct4() {
  return Container(
    ...
    child: ListView.builder(
      ...
      itemBuilder: (context, index) {
        final _menuItem = listProduct4[index];
        return InkWell(
            onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) {
                return DetailProduct4(data: _menuItem);
              }));
            },
            child: Container(
              width: 120,
