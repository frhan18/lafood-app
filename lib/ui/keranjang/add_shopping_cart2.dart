...
class AddShoppingCart2 extends StatefulWidget {
  final Product2 data;

  const AddShoppingCart2({
    Key? key,
    required this.data,
  }) : super(key: key);

  @override
  _AddShoppingCart2State createState() => _AddShoppingCart2State();
}

class _AddShoppingCart2State extends State<AddShoppingCart2> {
  @override
