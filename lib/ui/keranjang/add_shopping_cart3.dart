...
class AddShoppingCart3 extends StatefulWidget {
  final Product3 data;

  const AddShoppingCart3({
    Key? key,
    required this.data,
  }) : super(key: key);

  @override
  _AddShoppingCart3State createState() => _AddShoppingCart3State();
}

class _AddShoppingCart3State extends State<AddShoppingCart3> {
  @override
