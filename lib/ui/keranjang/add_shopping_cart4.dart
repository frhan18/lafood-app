...
class AddShoppingCart4 extends StatefulWidget {
  final Product4 data;

  const AddShoppingCart4({
    Key? key,
    required this.data,
  }) : super(key: key);

  @override
  _AddShoppingCart4State createState() => _AddShoppingCart4State();
}

class _AddShoppingCart4State extends State<AddShoppingCart4> {
  @override
